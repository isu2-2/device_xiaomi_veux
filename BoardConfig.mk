...
# Enable HIDL audio HAL wrappers in the framework
TARGET_USES_HIDL_AUDIO := true
#SOONG_CONFIG_NAMESPACES += lineageGlobalVars
#SOONG_CONFIG_lineageGlobalVars_target_uses_hidl_audio := true
...
TARGET_PROVIDES_AUDIO_EXTNS := true # (If you end up needing this back)
...
# KernelBOARD_KERNEL_BASE := 0x00000000
